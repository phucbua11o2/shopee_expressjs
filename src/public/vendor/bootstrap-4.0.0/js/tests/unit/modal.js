$(function () {
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            var $otherBtn = $('<button id="other-btn"/>').appendTo(
                '#qunit-fixture',
            );
    ...
    QUnit.test(
        'should adjust the inline margin of the navbar-toggler when opening and restore when closing',
        function (assert) {
            assert.expect(2);
            var done = assert.async();
            var $element = $('<div class="navbar-toggler"></div>').appendTo(
                '#qunit-fixture',
            );
            ...
            $('<div id="modal-test"/>')
                .on('hidden.bs.modal', function () {
                    ...
                    assert.strictEqual(
                        currentMargin,
                        originalMargin,
                        'navbar-toggler margin should be reset after closing',
                    );
                    $element.remove();
                    done();
                })
                .on('shown.bs.modal', function () {
                    ...
                    assert.strictEqual(
                        currentMargin,
                        expectedMargin,
                        'navbar-toggler margin should be adjusted while opening',
                    );
                    $(this).bootstrapModal('hide');
                })
                .bootstrapModal('show');
    ...
    QUnit.test(
        'should store the original margin of the navbar-toggler in data-margin-right before showing',
        function (assert) {
            assert.expect(2);
            var done = assert.async();
            var $element = $('<div class="navbar-toggler"></div>').appendTo(
