$(function () {
    ...
    QUnit.test('should show multiple collapsed elements', function (assert) {
        ...
        var $el2 = $('<div class="collapse multi"/>').appendTo(
            '#qunit-fixture',
        );
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            $(
                '<div id="body1" class="show" data-parent="#accordion"/>',
            ).appendTo($groups.eq(0));
            ...
            $('<div id="body2" data-parent="#accordion"/>').appendTo(
                $groups.eq(1),
            );
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            function secondTest() {
                ...
                assert.ok(
                    $collapseTwoOne.hasClass('show'),
                    '#collapseTwoOne is shown',
                );
                assert.ok(
                    $collapseTwoTwo.hasClass('show'),
                    '#collapseTwoTwo is shown',
                );
                done();
            }
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            var $target1 = $(
                '<div id="test1" class="multi collapse"/>',
            ).appendTo('#qunit-fixture');
            var $target2 = $(
                '<div id="test2" class="multi collapse"/>',
            ).appendTo('#qunit-fixture');
    ...
    QUnit.test(
        'should allow jquery object in parent config',
        function (assert) {
            assert.expect(1);
            var html =
