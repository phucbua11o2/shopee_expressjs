...
fs.createReadStream(workboxSWSrcPath).pipe(
    fs.createWriteStream(workboxSWDestPath),
);
fs.createReadStream(workboxSWSrcMapPath).pipe(
    fs.createWriteStream(workboxSWDestMapPath),
);
